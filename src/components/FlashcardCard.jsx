export default function FlashcardCard({ card, isFlipped, onFlip, onMark, isMarked, getDifficultyColor }) {
  return (
    <div className="relative w-80 h-96 mb-8">
      ...
      <div
        onClick={onFlip}
        className="absolute inset-0 bg-gradient-to-br from-white to-gray-50 rounded-2xl shadow-2xl p-8 flex flex-col items-center justify-between transform transition-all duration-500 hover:shadow-3xl cursor-pointer z-10 hover:scale-105 border border-gray-100"
        style={{
